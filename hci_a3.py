...
img1 = cv2.imread('img2.JPEG') # This is the image identified for overlaying
win_name = 'Camera Matching'
MIN_MATCH = 10
images = glob.glob('*.JPEG') #all the jpg images in the folder could be displayed
currentImage=0  #the first image is selected
def method_name():
    replaceImg=cv2.imread(images[currentImage])
    return replaceImg

replaceImg = method_name()
